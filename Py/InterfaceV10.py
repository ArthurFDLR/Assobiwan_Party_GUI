...
"}")
        ...
        self.JediButton.setGeometry(QtCore.QRect(1553*TAILLE_FENETRE, 764*TAILLE_FENETRE, 191*TAILLE_FENETRE, 192*TAILLE_FENETRE))
...
"}")
        ...
        self.SithButton.setGeometry(QtCore.QRect(105*TAILLE_FENETRE, 747*TAILLE_FENETRE, 186*TAILLE_FENETRE, 215*TAILLE_FENETRE))
...
"background-color: transparent;")
    ...
    ## Sabre interactif
        ...
        self.imageLbl_sabre.setGeometry(QtCore.QRect(625*TAILLE_FENETRE, 160*TAILLE_FENETRE, 600*TAILLE_FENETRE, 600*TAILLE_FENETRE))
    ...
    ## Reward
        ...
        self.imageLbl_reward_jedi.setGeometry(QtCore.QRect(0*TAILLE_FENETRE, 0*TAILLE_FENETRE, 1850*TAILLE_FENETRE, 1000*TAILLE_FENETRE))
        ...
        pixmap = pixmap.scaled(self.imageLbl_reward_jedi.width(), self.imageLbl_reward_jedi.height(), QtCore.Qt.KeepAspectRatio)
        ...
        self.imageLbl_reward_sith.setGeometry(QtCore.QRect(0*TAILLE_FENETRE, 0*TAILLE_FENETRE, 1850*TAILLE_FENETRE, 1000*TAILLE_FENETRE))
        ...
        pixmap = pixmap.scaled(self.imageLbl_reward_sith.width(), self.imageLbl_reward_sith.height(), QtCore.Qt.KeepAspectRatio)
    ...
    ##Alarm Invasion
        ...
        self.imageLbl_Alarm.setGeometry(QtCore.QRect(0*TAILLE_FENETRE, 0*TAILLE_FENETRE, 1850*TAILLE_FENETRE, 642*TAILLE_FENETRE))
    ...
    ##Re Ouvrir panneau de controle
        ...
        self.Button_Commandes.setGeometry(QtCore.QRect(500*TAILLE_FENETRE, 747*TAILLE_FENETRE, 850*TAILLE_FENETRE, 215*TAILLE_FENETRE))
...
class Ui_ControlWindow(QMainWindow):
    ...
    def Confirmation_Reinitialisation(self):
        buttonReply = QMessageBox.question(self, 'Confirmation', "Confirmer la réinitialisation de la partie ?", QMessageBox.Yes | QMessageBox.No, QMessageBox.No)

...
"QWidget{\n"
"    background-image: url(res/BackGroundV1.png)\n"
"}")
...
"background-color: rgb(0, 0, 0);")
    ...
    ## Tableau d'honneur
        ...
        self.Nom_gagnant.setGeometry(QtCore.QRect(200, 60, 1000, 120))
